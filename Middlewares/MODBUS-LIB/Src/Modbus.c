...
extern int32_t CalculateAverageCurrent();
extern int32_t CalculateAverageVoltage();
extern osTimerId_t GreenLedOffTimerHandle;
...
static int8_t process_FC2(modbusHandler_t *modH );
...
//static int8_t process_FC7(modbusHandler_t *modH );
//static int8_t process_FC8(modbusHandler_t *modH );
//static int8_t process_FC9(modbusHandler_t *modH );
//static int8_t process_FC10(modbusHandler_t *modH );
//static int8_t process_FC11(modbusHandler_t *modH );
//static int8_t process_FC12(modbusHandler_t *modH );
//static int8_t process_FC13(modbusHandler_t *modH );
//static int8_t process_FC14(modbusHandler_t *modH );
...
/**
 * @brief
 * This method processes functions 1 (coils) & 2 (discrete inputs)
...
/**
 * @brief
 * This method processes functions 3 - Read Holding Registers
...
/**
 * @brief
 * This method processes functions 4  Read Input Registers
 * This method reads a word array and transfers it to the master
 *
 * @return u8BufferSize Response to master length
 * @ingroup register
...
/**
 * @brief
 * This method processes function 5 - Write Coil
...
/**
 * @brief
 * This method processes function 6 - Holding Register
...
/**
 * @brief
 * This method processes function 16 Write Multiple Holding Registers
