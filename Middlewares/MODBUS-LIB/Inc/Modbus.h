...
typedef enum MB_FC
{
    ...
    MB_FC_READ_DISCRETE_INPUT 			= 2,	 /*!< FCT=2 -> read discrete inputs */
    MB_FC_READ_HOLDING_REGISTER		= 3,	 /*!< FCT=3 -> read registers or analog outputs */
    MB_FC_READ_INPUT_REGISTER 			= 4,	 /*!< FCT=4 -> read inputs */
    MB_FC_WRITE_COIL									= 5,	 /*!< FCT=5 -> write single coil */
    MB_FC_WRITE_HOLDING_REGISTER		= 6,	 /*!< FCT=6 -> write single holding register */
    MB_FC_WRITE_MULTIPLE_COILS			= 15, /*!< FCT=15 -> write multiple coils  */
    MB_FC_WRITE_MULTIPLE_REGISTERS	= 16	 /*!< FCT=16 -> write multiple holding registers */
}mb_functioncode_t;
...
// #define FLASH_STORAGE_PAGE	0x0801FC00	// 128K in, this is the last page 1K pages (Blue Pill)
#define FLASH_STORAGE_PAGE	0x0800F800		// 64K in 2K pages, this is the last page
typedef struct {
	struct {
		struct {
			int16_t Reading;
...
/**
 * CalculateChecksum returns tha calculated chacksum value
 */
